...
import { Plus, BarChart3, Moon, Sun, RotateCcw, RefreshCw, Settings, Download, Upload, Layout } from 'lucide-react';
import { clearDashboardStorage } from '@/lib/clearStorage';
import { exportDashboard, importDashboard, downloadDashboard, uploadDashboard } from '@/lib/dashboardExport';
...
const DashboardContent: React.FC = () => {
    ...
    const demoWidgets = [
      {
        ...
        selectedFields: [
          ...
          { path: 'data.rates.USD', label: 'USD Price', type: 'string' as const, format: 'currency' as const },
          { path: 'data.rates.EUR', label: 'EUR Price', type: 'string' as const, format: 'currency' as const }
        ],
        ...
        config: {}
         ...
         selectedFields: [
           ...
           { path: 'price', label: 'Price', type: 'number' as const, format: 'currency' as const },
           { path: 'change', label: 'Change', type: 'number' as const, format: 'currency' as const },
           { path: 'changePercent', label: 'Change %', type: 'number' as const, format: 'percentage' as const }
         ],
  ...
  const handleExportDashboard = () => {
    try {
      ...
      downloadDashboard(config, `finboard-dashboard-${new Date().toISOString().split('T')[0]}.json`);
      addToast({
        type: 'success',
  ...
  const handleLoadTemplate = async (template: typeof dashboardTemplates[0]) => {
    if (widgets.length > 0 && !confirm('This will replace your current dashboard. Are you sure?')) {
      return;
    }
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3 justify-between">
              {/* <div className="bg-gradient-to-r from-green-500 to-blue-600 p-2 rounded-xl shadow"> */}
                ...
                <svg width="320" height="50" viewBox="0 0 620 90" xmlns="http://www.w3.org/2000/svg">
  {/* <!-- Background --> */}
  <rect width="320" height="90" fill="#0f172a" rx="12"/>
  
  {/* <!-- Finance Icon: Candlestick chart --> */}
  {/* <!-- Green candlestick --> */}
  <rect x="35" y="30" width="10" height="30" fill="#10b981" rx="2"/>
  <line x1="40" y1="20" x2="40" y2="30" stroke="#10b981" stroke-width="3" stroke-linecap="round"/>
  <line x1="40" y1="60" x2="40" y2="70" stroke="#10b981" stroke-width="3" stroke-linecap="round"/>
  
  {/* <!-- White candlestick --> */}
  <rect x="55" y="20" width="10" height="40" fill="#ffffff" rx="2"/>
  <line x1="60" y1="10" x2="60" y2="20" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/>
  <line x1="60" y1="60" x2="60" y2="75" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/>
  
  {/* <!-- Green candlestick --> */}
  <rect x="75" y="25" width="10" height="35" fill="#10b981" rx="2"/>
  <line x1="80" y1="15" x2="80" y2="25" stroke="#10b981" stroke-width="3" stroke-linecap="round"/>
  <line x1="80" y1="60" x2="80" y2="70" stroke="#10b981" stroke-width="3" stroke-linecap="round"/>
  
  {/* <!-- Text --> */}
  <text x="120" y="55" font-family="Inter, sans-serif" font-size="30" fill="#ffffff" font-weight="700">
    FinBoard
  </text>
</svg>
              {/* </div> */}
    ...
    >
      ...
      <div
        ...
        onMouseEnter={e => {
          ...
          e.currentTarget.style.boxShadow = '0 0 16px 2px rgba(34,197,94,0.35)';
        }}
        onMouseLeave={e => {
  ...
  <DragOverlay>
    {activeWidget ? (
      ...
      {/* Footer */}
      {widgets.length > 0 && (
        <footer className="mt-16 shadow-inner mb-0" style={{ background: 'var(--card)', borderTop: '1px solid var(--border)' }}>
